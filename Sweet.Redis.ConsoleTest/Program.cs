...
namespace Sweet.Redis.ConsoleTest
{
    class Program
    {
        ...
        static void MultiThreading10e()
        {
            ...
            MultiThreadingBasePool(12, 5, 1, 5000, testKey, tinyText, true, 5,
                               (rdb, dbIndex) => { return rdb.Strings.Get(testKey); },
                               false, true);
        }
        ...
        static void MultiThreading10d()
        {
            ...
            MultiThreadingBasePool(12, 1, 50, 100, testKey, tinyText, true, 5,
                               (rdb, dbIndex) => { return rdb.Strings.Get(testKey); },
                               false, true);
        }
        ...
        static void MultiThreading10c()
        {
            ...
            MultiThreadingBasePool(12, 5, 50, 100, testKey, tinyText, true, 5,
                               (rdb, dbIndex) => { return rdb.Strings.Get(testKey); },
                               false, true);
        }
                                       ...
                                       bool useAsyncCompleter = true)
        {
            using (var pool = new RedisConnectionPool("My redis pool",
                     ...
                     new RedisPoolSettings("127.0.0.1", 6379, maxConnectionCount: maxCount, useAsyncCompleter: useAsyncCompleter))) // LOCAL
            {
